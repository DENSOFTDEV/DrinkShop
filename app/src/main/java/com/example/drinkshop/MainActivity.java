...
import com.facebook.accountkit.ui.AccountKitEmailRedirectActivity;
...
public class MainActivity extends AppCompatActivity {
                                    ...
                                    if (userResponse.isExists())
                                    {
                                        ...
                                        mService.getUserInformation(account.getPhoneNumber().toString()).enqueue(new Callback<User>() {
                                            ...
                                            public void onResponse(Call<User> call, Response<User> response) {
                                                ...
                                                //if user already exists start a new activity
                                                alertDialog.dismiss();
    ...
    private void startActivity(LoginType loginType) {
        ...
        if (requestCode == REQUEST_CODE)
        {
            ...
            else
            {
                if (result.getAccessToken() != null)
                {
                    ...
                    //Get User And check exists on the server
                    AccountKit.getCurrentAccount(new AccountKitCallback<Account>() {
                        @Override
                        public void onSuccess(final Account account) {
                            mService.checkUserExists(account.getPhoneNumber().toString())
